module;
#include "../interfaces/Coro/Config.hpp"
#include <atomic>
#include <exception>
#include <utility>
#include <type_traits>
...
#include <cassert>
#include <coroutine>
export module Maximus.Coro.Task;

// import Maximus.Coro.Config;
import Maximus.Coro.AwaitableTraits;
import Maximus.Coro.BrokenPromise;
import Maximus.Coro.RemoveRValueReference;
